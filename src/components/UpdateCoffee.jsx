...
const UpdateCoffee = () => {
    ...
    const handleUpdateCoffee = (event) => {
        ...
        fetch(`https://coffee-store-server-kgsp7moai-shazzad-shuvo.vercel.app/coffee/${_id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
        <div className="bg-[#F4F3F0] p-24">
            ...
            <form onSubmit={handleUpdateCoffee}>
                ...
                <input type="submit" value="Update Coffee" className="btn btn-primary btn-block" />
            </form>
        </div>
    );
};
